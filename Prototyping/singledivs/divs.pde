...
void div() {
  ...
  //div[4] = AppWidth * 34/paperheight;
 // div[5] = AppHeight * 12/paperwidth;
  //div[6] = AppWidth * 100/paperheight;
  //div[7] = AppHeight * 45/paperwidth;
 ...
 for(int i=0; i<div.length; i+=4){
   ...
   //rectdiv(div[i+4],div[i+5], div[i+6], div[i+7]);
 } 
}//end divs
